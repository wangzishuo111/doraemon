...
db = mongo_operator.MongoOperator(
    ...
    'version_management',
    'service_version')
old_server_list = ["autohdmap_multi_merge_cli", "test_lane_client", "autohdmap_multi_groundsymbol_client", "autohdmap_multisign_client"]
server_list = ["pole", "ground", "auto", "fusion"]
