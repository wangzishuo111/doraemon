...
function(t) {
    t.fn.countdown = function(e, n) {
        function o() {
            ...
            i.find(".days").text(c),
            i.find(".hours").text(t.getHours()),
            i.find(".minutes").text(t.getMinutes()),
            i.find(".seconds").text(t.getSeconds()),
            i.find(".days_text").text(y),
            i.find(".hours_text").text("Hour"),
            i.find(".minutes_text").text("Minute"),
            i.find(".seconds_text").text("Second")
        }
        var r = t.extend({
            date: null,
            offset: null,
